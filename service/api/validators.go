...
func (rt *_router) userWithoutPermissions(w http.ResponseWriter, uid int64, auth int64) bool {
...
func (rt *_router) usernameNotValid(w http.ResponseWriter, username string) bool {
