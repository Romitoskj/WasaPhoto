			...
			<div class="card-body d-flex justify-content-end gap-1">
				...
				<div class="d-flex align-items-center">
					<button @click="getComments" type="button" class="btn btn-link d-flex align-items-center gap-3 text-dark" data-bs-toggle="modal" :data-bs-target="`#Comments${this.photo.identifier}`">
						...
						<span class="text-muted">{{ this.photo.comments_n }}</span> <!-- TODO increment or decrement when adding or deleting comment -->
					</button>
				</div>
				...
				<div class="d-flex align-items-center gap-1">
					...
					<button type="button" @click="getLikes" class="btn btn-link d-flex align-items-center text-muted"  data-bs-toggle="modal" :data-bs-target="`#Likes${this.photo.identifier}`">{{ this.photo.likes_n }}</button>
				</div>
			</div>
