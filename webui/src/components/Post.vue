...
<template>
		...
		<div v-if="!deleted" class="d-flex justify-content-between">
			...
			<div class="card-body d-flex justify-content-end">
				...
				<div class="d-flex align-items-center gap-1">
					...
					<button type="button" class="btn btn-link d-flex align-items-center text-muted"  data-bs-toggle="modal" data-bs-target="#Likes">{{ this.photo.likes_n }}</button>
				</div>
			</div>
	...
	<UsersModal header="Likes" :url="`/users/${photo.author.identifier}/photos/${photo.identifier}/likes/`"></UsersModal>
</template>
